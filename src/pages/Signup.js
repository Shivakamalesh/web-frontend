     ...
     <div className="row ">
        ...
        {/* Password*/}
            ...
            <div className="row mt-3">
                ...
                <button type="submit" className="btn btn-warning loginButton" onClick={handleDealersignup}>Admin Signup</button>  
            </div>
                <div className="col-6 text-center">
                <button type="submit" className="btn btn-warning loginButton" onClick={handleResellersignup}> User Signup</button>  
                </div>
            </div> 
